...
export default function Header() {
  return (
    <header className="h-20 px-10 w-screen fixed flex hover:bg-white items-center justify-between top-0 left-0 z-10 transition-all group/header">
      <Link to="">
      ...
      <nav className="h-20 flex items-center gap-x-5 justify-center">
        <div className="flex flex-col group">
          <Link
            to="/"
            className="text-white group-hover/header:text-black flex items-center mt-8 pb-5 hover:text-blue-400"
          >
